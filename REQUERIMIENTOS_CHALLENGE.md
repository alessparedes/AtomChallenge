...
* **Hosting:** Servidor VPS con Ubuntu para el despliegue de la demo con docker-compose.
...
1. **Dashboard:** 
    - Funcionalidad CRUD visible: Lista de flujos guardados con el nombre del flujo, fecha de creacion. Cada elemento de la lista de tarjetas debe tener botones o menú contextual para: [Abrir, Duplicar, Renombrar, Eliminar, desplegar].
    - Botón de Acción: Un botón destacado de '+ Nuevo Flujo'.

2. **Editor:** 
    - Esta pantalla proviene de dashboard al presionar abrir, seria el flujo seleccionado en el dashboard.
    - Canvas de nodos con auto-guardado en PostgreSQL e indicador de sincronización con la base de datos, badge que diga 'Guardado' o 'Sin Guardar' en la parte superior. 
...
3. **Despliegues:** 
   - Esta pantalla proviene de dashboard al presionar desplegar, seria el flujo seleccionado en el dashboard.
...
## 6. GESTIÓN DE PERSISTENCIA (PostgreSQL)
...
* **Persistencia del Editor:** El estado del canvas (posiciones y configuraciones) DEBE guardarse automáticamente para que no se pierda al cerrar el navegador (PostgreSQL).
